...
2. [Data Clean](#data-clean)  
  2.1 [s.dc.outlier_detector](#s-dc-outlier-detector)  
  2.2 [s.dc.missing_detector](#s-dc-missing-detector)  
  2.3 [s.dc.sample_missing](#s-dc-sample-missing)  
  2.4 [s.dc.missing_imputation](#s-dc-missing-imputation)
...
nrow(newDT07)
```
<a id = 's-dc-missing-imputation'> </a>
